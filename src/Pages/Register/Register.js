    ...
    return (
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-red-300 dark:text-gray-100 mx-auto mt-20 mb-20">
            ...
            <form onSubmit={handleSignUp} className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <div className="space-y-1 text-sm">
                    <label for="address" className="block dark:text-gray-400">Email</label>
                    <input type="email" name="email" id="email" placeholder="Inter Email Your Address" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                </div>
                <div className="space-y-1 text-sm">
                    <label for="photoURL" className="block dark:text-gray-400">Photo URL</label>
                    <input type="text" name="photoURL" id="photoURL" placeholder="Inter Your Photo URL" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                </div>
                <div className="space-y-1 text-sm">
