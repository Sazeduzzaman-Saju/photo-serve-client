    ...
    return (
        <div className="px-3 md:lg:xl:px-40 bg-opacity-10">
            <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
                ...
                <div
                    className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-violet-300 cursor-pointer">
                ...
                <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-violet-300 cursor-pointer">
                ...
                <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-violet-300 cursor-pointer">
                ...
                <div className="p-10 flex flex-col items-center text-center group     hover:bg-violet-300 cursor-pointer">
            ...
            <div className="w-full   bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center">
                <p className=" text-white"> <span className="text-4xl font-medium">Still Confused ?</span> <br /> <span className="text-lg">Book For 50% Off Career Consultation Today ! </span></p>
                <Link to={'/services'}><button className="custom-btn btn-6">BOOK AN SERVICE </button></Link>
            </div>
