...
const ShortDetails = () => {
    return (
        <div class="px-3 md:lg:xl:px-40 bg-opacity-10">
            <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">


                <div
                    class="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-violet-300 cursor-pointer">
                ...
                <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-violet-300 cursor-pointer">
                ...
                <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-violet-300 cursor-pointer">
                ...
                <div class="p-10 flex flex-col items-center text-center group     hover:bg-violet-300 cursor-pointer">
            ...
            <div class="w-full   bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center">
                <p class=" text-white"> <span class="text-4xl font-medium">Still Confused ?</span> <br /> <span class="text-lg">Book For 50% Off Career Consultation Today ! </span></p>
                <Link to={'/services'}><button class="custom-btn btn-6">BOOK AN SERVICE </button></Link>
            </div>
