...
const Blog = () => {
    return (
        <div>
            ...
            <div className='w-1/2 max-w-screen-xl mx-auto mb-20'>
                <h1 className='text-4xl text-center mb-10 font-bold mt-10'>Important Question</h1>
                ...
                <div tabIndex={1} className="collapse collapse-arrow border border-base-300 bg-base-100 ">
                    ...
                    <div className="collapse-content">
                        <p>(JWT) is an open standard (RFC 7519) for securely transmitting information between parties as JSON object. It is compact, readable and digitally signed using a private key/ or a public key pair by the Identity Provider(IdP)</p>
                    </div>
                </div>
                ...
                <div tabIndex={3} className="collapse collapse-arrow border border-base-300 bg-base-100 ">
                    ...
                    <div className="collapse-content">
                        <p> NodeJS handle multiple client requests? NodeJS receives multiple client requests and places them into EventQueue. NodeJS is built with the concept of event-driven architecture. NodeJS has its own EventLoop which is an infinite loop that receives requests and processes them.</p>
                    </div>
                </div>
            </div>
        </div>
